defmodule DelivWeb.RestaurantControllerTest do
  use DelivWeb.ConnCase

  alias Deliv.Admin

  @create_attrs %{address: "some address", cnpj: "some cnpj", name: "some name", phone: "some phone"}
  ...
  def fixture(:restaurant) do
    {:ok, restaurant} = Admin.create_restaurant(@create_attrs)
    restaurant
  end

defmodule DelivWeb.EnsureRolePlug do
  @moduledoc """
  This plug ensures that a user has a particular role.

  ## Example

      plug DelivWeb.EnsureRolePlug, [:user, :admin]

      plug DelivWeb.EnsureRolePlug, :admin

      plug DelivWeb.EnsureRolePlug, ~w(user admin)a
  """
